...
@dag(
    ...
    schedule="0 17 * * *",
    start_date=pendulum.from_format("2024-01-16", "YYYY-MM-DD").in_tz("Brazil/East"),
    catchup=False,
    owner_links={
        "paulodshamaral@gmail.com": "mailto:paulodshamaral@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clrgqk8m5068i01qzvoypewgq/cloud-ide/clrgqkm1u00jq01ngejwbgqb3/clrgqkmcn068j01qztlzy7ovf",
    },
)
